/// 32 Farz — Namazın 12 (rükünleri ve şartları), İmanın 6, İslam'ın 5,
/// Abdestin 4, Guslün 3 ve Teyemmümün 2 farzı; çoktan aza sıralanır.
/// İçerik sabittir; Diyanet İlmihali'ne (Hanefî) dayanır.
class FardItem {
  final String nameTr;
  final String nameAr;
  final String nameEn;
...
const List<FardGroup> thirtyTwoFard = [
  FardGroup('Namazın Farzları – İçindekiler: Rükünleri (6)', 'فرائض الصلاة – أركانها (٦)', 'Obligations of Prayer – Integrals (6)', [
    FardItem('İftitah tekbiri', 'تكبيرة الإحرام', 'Opening takbir',
        'Namaza \'Allâhü Ekber\' diyerek başlamaktır.',
        'الدخول في الصلاة بقول «الله أكبر».',
        'To begin the prayer saying \'Allahu Akbar.\''),
    FardItem('Kıyam', 'القيام', 'Standing',
        'Gücü yetenin namazda ayakta durmasıdır.',
        'الوقوف في الصلاة للقادر.',
        'Standing during prayer for those able.'),
    FardItem('Kıraat', 'القراءة', 'Recitation',
        'Namazda Kur\'an\'dan bir miktar okumaktır.',
        'قراءة ما تيسر من القرآن في الصلاة.',
        'Reciting a portion of the Quran in prayer.'),
    FardItem('Rükû', 'الركوع', 'Bowing',
        'Eller dizlere erecek şekilde eğilmektir.',
        'الانحناء حتى تبلغ اليدان الركبتين.',
        'Bowing until the hands reach the knees.'),
    FardItem('Secde', 'السجود', 'Prostration',
        'Alın, burun, eller, dizler ve ayak parmakları yere değecek şekilde her rekatta iki kez secde etmektir.',
        'وضع الجبهة والأنف واليدين والركبتين وأطراف القدمين على الأرض مرتين في كل ركعة.',
        'Prostrating twice each rak\'ah with forehead, nose, hands, knees and toes on the ground.'),
    FardItem('Ka\'de-i ahîre', 'القعدة الأخيرة', 'Final sitting',
        'Namazın sonunda Ettehiyyâtü okuyacak kadar oturmaktır.',
        'الجلوس آخر الصلاة بمقدار التشهد.',
        'Sitting at the end of prayer long enough to recite the tashahhud.'),
  ]),
  FardGroup('Namazın Farzları – Dışındakiler: Şartları (6)', 'فرائض الصلاة – شروطها (٦)', 'Obligations of Prayer – Preconditions (6)', [
    FardItem('Hadesten taharet', 'الطهارة من الحدث', 'Purity from ritual impurity',
        'Namazdan önce abdestsizlik hâlinden abdestle, gerekiyorsa gusülle temizlenmektir.',
        'رفع الحدث بالوضوء أو الغسل قبل الصلاة.',
        'To remove ritual impurity with wudu or ghusl before prayer.'),
    FardItem('Necasetten taharet', 'الطهارة من النجاسة', 'Purity from filth',
        'Beden, elbise ve namaz kılınacak yerin temiz olmasıdır.',
        'طهارة البدن والثوب ومكان الصلاة.',
        'Cleanliness of body, clothing and place of prayer.'),
    FardItem('Setr-i avret', 'ستر العورة', 'Covering the body',
        'Örtülmesi gereken yerlerin namazda örtülü olmasıdır.',
        'ستر ما يجب ستره في الصلاة.',
        'Covering what must be covered during prayer.'),
    FardItem('İstikbâl-i kıble', 'استقبال القبلة', 'Facing the qibla',
        'Namazda Kâbe yönüne dönmektir.',
        'التوجه إلى الكعبة في الصلاة.',
        'Facing the direction of the Kaaba in prayer.'),
    FardItem('Vakit', 'الوقت', 'The prescribed time',
        'Her namazı kendi vakti içinde kılmaktır.',
        'أداء كل صلاة في وقتها.',
        'Praying each prayer within its time.'),
    FardItem('Niyet', 'النية', 'Intention',
        'Hangi namazın kılınacağını kalben belirlemektir.',
        'عقد القلب على الصلاة المعينة.',
        'To determine in the heart which prayer is being performed.'),
  ]),
